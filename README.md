...
риск схемы. Дешёвый платный агрегатор: `z-ai/glm-5.3-flash` ($0.06/$0.20 за 1M,
1.31M ctx, vision) — центы в день при текущем объёме. Решение о подписке — за
владельцем; без неё схема полностью рабочая на free-моделях (см. таблицу выше).
